...
required to build the dsPIC33AK CMSIS-Driver SAI wrapper used by this project.
...
needed by the local SAI CMSIS-Driver wrapper. It is not a full CMSIS, CMSIS-Core,
